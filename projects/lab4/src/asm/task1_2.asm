...
addi    x1,     zero,   8               ; row counter = 8
addi    x2,     zero,   8               ; col counter = 8
addi    x3,     zero,   8               ; k counter = 8
addi    x4,     zero,   0               ; i = 0
addi    x28,    x0,     2               ; x28 = 2
row_loop:
    addi    x9,     zero,   0           ; j = 0
    col_loop:
        ...
        k_loop:
            ...
            addi    x10,    x10,    1       ; k++
            blt     x10,    x3,     k_loop  ; if k < 8 continue k_loop
        ...
        addi    x9,     x9,     1           ; j++
        blt     x9,     x2,     col_loop    ; if j < 8 continue col_loop
